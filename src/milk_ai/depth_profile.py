...
COSMICOXES_GRAMMAR: dict[str, str] = {
    ...
    "dopafania_bloom": "salience bloom — condensacao de saliencia (NUNCA representacao pseudo-cientifica de dopamina)",
    "tension": "forca direcional entre dois pontos",
    "threshold": "zona de transicao entre estados",
    "depth": "dimension vertical de camadas sobrepostas",
