...
# ===========================================================================
# Complexity delta: Morin, Forrester, von Foerster, Bertalanffy, Lorenz,
# Wiener, Prigogine
# ===========================================================================

_dp("person:edgar_morin",
    source_pointer="source:morin:la_methode",
    source_type="PHILOSOPHY", author="Edgar Morin",
    work="La Méthode (6 vols, 1977-2004), Introduction à la pensée complexe (1990)",
    epistemic_status="SOURCE",
    historical_context="Late 20th century French philosophy of complexity",
    foundational_problem="How to distinguish and connect without reducing one to the other?",
    foundational_question="How can complexity hold distinction, conjunction, and uncertainty together?",
    conceptual_nucleus="dialogical principle / organizational recursion / hologrammatic principle",
    extended_definition="Complexity is NOT the rejection of distinction. It is the capacity to DISTINGUISH AND CONNECT without reducing one to the other. Dialogical: antagonistic principles may be antagonistic AND concurrent AND complementary. Recursive: products become producers of what produced them. Hologrammatic: part exists in whole AND whole is present in the organization of the part — without literal identity. Anti-holism warning: 'everything is connected to everything' is useless; a relation needs mechanism, context, boundary, evidence, non-equivalence.",
    what_it_changes="Introduces a mode of thought that holds contradiction, recursion, and uncertainty as structural, not as error.",
    what_it_resists="Reductionism; vague holism; automatic resolution of antagonisms; 'everything is connected' without mechanism.",
    what_it_is_not="NOT vague holism; NOT 'everything is connected'; NOT relativism; complexity increases contextual rigor.",
    axes={"ontology": "dialogical coexistence", "temporality": "organizational recursion", "uncertainty": "first-class, not eliminated", "transformation": "recursion: products become producers"},
    conceptual_neighbors=["person:jay_wright_forrester", "person:heinz_von_foerster", "person:ludwig_von_bertalanffy", "method:deleuze", "method:llansol"],
    misreading_risks=["Reducing to 'complexity' as buzzword", "Confusing with vague holism"])

_dp("person:jay_wright_forrester",
    source_pointer="source:forrester:industrial_dynamics",
    source_type="SYSTEMS_SCIENCE", author="Jay Wright Forrester",
    work="Industrial Dynamics (1961), Principles of Systems (1968), Urban Dynamics (1969), World Dynamics (1971)",
    epistemic_status="SOURCE",
    historical_context="MIT, 1950s-70s, from servomechanisms to social systems",
    foundational_problem="How does the internal structure of a system generate its behaviour over time?",
    foundational_question="Can observed behaviour be generated by endogenous feedback structure rather than external events?",
    conceptual_nucleus="stock/flow / feedback loop / delay / endogenous structure / behaviour over time",
    extended_definition="System Dynamics is a rigorous mathematical/computational method. Core primitives: STOCK (accumulation), FLOW (rate of change), FEEDBACK LOOP (reinforcing R or balancing B), DELAY (first-class: cause may produce observable effect much later), ENDOGENOUS STRUCTURE (system structure generates behaviour). dS/dt = inflows - outflows. Reinforcing loops: growth/collapse. Balancing loops: goal-seeking/stabilization. Delays in balancing loops produce overshoot, oscillation, instability. NOT exact forecasting — used for simulation, scenario exploration, policy testing, sensitivity analysis. Prediction only when data, model, calibration, uncertainty, validation actually support it.",
    what_it_changes="Shows that system behaviour over time can be generated by internal feedback structure, not just external events.",
    what_it_resists="Linear causality; instantaneous-effect assumption; exact prediction without calibration; reducing to 'feedback' alone.",
    what_it_is_not="NOT 'systems thinking' (vague); NOT exact forecasting; NOT applicable to human experience without explicit calibration.",
    axes={"temporality": "behaviour over time, delay as first-class", "sociality": "endogenous structure generates behaviour", "uncertainty": "sensitivity analysis, scenario exploration", "transformation": "stock/flow accumulation and depletion"},
    conceptual_neighbors=["person:edgar_morin", "person:norbert_wiener", "person:ilya_prigogine", "method:freire"],
    misreading_risks=["Reducing to 'feedback'", "Claiming exact prediction", "Converting qualitative experience into numbers without justification"])

_dp("person:heinz_von_foerster",
    source_pointer="source:von_foerster:observing_systems",
    source_type="CYBERNETICS", author="Heinz von Foerster",
    work="Observing Systems (1981), Understanding Understanding (2003)",
    epistemic_status="SOURCE",
    historical_context="Biological Computer Laboratory, Urbana, 1958-1976",
    foundational_problem="What happens when the observer enters the observation?",
    foundational_question="How does the observing system differ from the observed system?",
    conceptual_nucleus="second-order cybernetics / observing systems / recursive observation / order from noise",
    extended_definition="First-order: cybernetics of observed systems. Second-order: cybernetics of observing systems. The observer/describer MUST enter the epistemology of the observation. NOT 'the observer physically disturbs everything' — the deeper point is epistemological: the observer's distinctions shape what becomes visible. Observer -> distinction -> observation -> description -> intervention -> system response -> new observer state -> new observation. Order from noise: structure can emerge from apparent disorder.",
    what_it_changes="Makes the observer a constitutive part of the observed system, not an external god's-eye view.",
    what_it_resists="God's-eye objectivity; the assumption that observation leaves the observed unchanged; relativistic collapse ('anything is true').",
    what_it_is_not="NOT 'the observer physically disturbs everything'; NOT relativism; does NOT abandon factual verification.",
    axes={"ontology": "observing systems, not just observed", "perception": "observer distinctions shape visibility", "uncertainty": "epistemic limit of observation", "sociality": "observer is causal participant"},
    conceptual_neighbors=["person:edgar_morin", "person:norbert_wiener", "method:maturana_varela", "method:merleau_ponty"],
    misreading_risks=["Reducing to 'observer'", "Confusing with relativism"])

_dp("person:ludwig_von_bertalanffy",
    source_pointer="source:bertalanffy:general_system_theory",
    source_type="SYSTEMS_SCIENCE", author="Ludwig von Bertalanffy",
    work="General System Theory (1968)",
    epistemic_status="SOURCE",
    historical_context="Mid-20th century, biology to general systems",
    foundational_problem="What exists only because the parts are organized in relation?",
    foundational_question="How do parts + relations + organization + environment = system behaviour?",
    conceptual_nucleus="General System Theory / open systems / part-whole / interdependence",
    extended_definition="Methodological system thinking: PARTS + RELATIONS + ORGANIZATION + ENVIRONMENT = SYSTEM BEHAVIOUR. NOT 'whole before parts' as dogma — WHOLE <-> PARTS bidirectional contextualization. Open system: exchanges with environment. Emergent property: what exists only because of organization. Key question: WHAT EXISTS ONLY BECAUSE THE PARTS ARE ORGANIZED IN RELATION?",
    what_it_changes="Introduces systematic analysis of parts/relations/organization/environment.",
    what_it_resists="Reduction to isolated parts; vague holism ('whole > parts' as dogma); encoding 'whole before parts' as axiom.",
    what_it_is_not="NOT 'whole > parts' as dogma; NOT vague holism; it is methodological analysis.",
    axes={"ontology": "parts + relations + organization = system", "territory": "system/environment exchange", "sociality": "interdependence"},
    conceptual_neighbors=["person:edgar_morin", "person:jay_wright_forrester", "person:ilya_prigogine"],
    misreading_risks=["Reducing to 'whole > parts'", "Treating as vague holism"])

_dp("person:edward_norton_lorenz",
    source_pointer="source:lorenz:deterministic_nonperiodic_flow",
    source_type="MATHEMATICS", author="Edward Norton Lorenz",
    work="Deterministic Nonperiodic Flow (1963)",
    epistemic_status="SOURCE",
    historical_context="MIT, 1960s meteorology, numerical weather prediction",
    foundational_problem="Why is deterministic dynamics not practically predictable?",
    foundational_question="Can nearby initial states diverge strongly over time in a deterministic system?",
    conceptual_nucleus="deterministic chaos / sensitive dependence / strange attractors / predictability horizon",
    extended_definition="CHAOS != RANDOMNESS. CHAOS != 'everything changes everything'. In some nonlinear dynamical systems, nearby initial states may diverge strongly over time (sensitive dependence on initial conditions). DETERMINISTIC does NOT imply PRACTICALLY PREDICTABLE. Strange attractors: bounded but non-periodic trajectories. Predictability horizon: time beyond which prediction becomes unreliable. The Lorenz equations: dx/dt=sigma(y-x), dy/dt=x(rho-z)-y, dz/dt=xy-beta*z. CHAOS is NOT an excuse for arbitrary association.",
    what_it_changes="Shows that determinism and predictability are distinct; limits of predictability are structural.",
    what_it_resists="Equating chaos with randomness; 'butterfly effect' as popular oversimplification; using chaos as excuse for arbitrary association.",
    what_it_is_not="NOT randomness; NOT 'everything affects everything'; NOT an excuse for ungrounded association.",
    axes={"temporality": "predictability horizon, sensitive dependence", "uncertainty": "structural limit of prediction", "transformation": "nearby states diverge"},
    conceptual_neighbors=["person:jay_wright_forrester", "method:chaos_complexity", "person:ilya_prigogine"],
    misreading_risks=["Reducing to 'butterfly effect'", "Using chaos as excuse for arbitrary association"])

_dp("person:norbert_wiener",
    source_pointer="source:wiener:cybernetics",
    source_type="CYBERNETICS", author="Norbert Wiener",
    work="Cybernetics: or Control and Communication in the Animal and the Machine (1948)",
    epistemic_status="SOURCE",
    historical_context="MIT, 1940s, anti-aircraft fire control to general theory",
    conceptual_nucleus="cybernetics / communication / control / feedback / circular causality",
    extended_definition="Cybernetics: the study of control and communication in systems. Feedback: circular causal loops. Communication: information transmission. Control: regulation through feedback. Circular causality: A affects B affects A.",
    what_it_changes="Introduces circular causality as a fundamental principle.",
    what_it_resists="Linear causality; the separation of control from communication.",
    what_it_is_not="NOT just 'feedback'; NOT engineering only; it is a general theory of control/communication.",
    axes={"sociality": "control through communication", "temporality": "circular causality, feedback loops", "uncertainty": "information and noise"},
    conceptual_neighbors=["person:heinz_von_foerster", "person:jay_wright_forrester", "person:ludwig_von_bertalanffy"],
    misreading_risks=["Reducing to 'feedback'"])

_dp("person:ilya_prigogine",
    source_pointer="source:prigogine:order_out_of_chaos",
    source_type="PHYSICS", author="Ilya Prigogine",
    work="Order Out of Chaos (1984, with Stengers)",
    epistemic_status="SOURCE",
    historical_context="Non-equilibrium thermodynamics, Brussels school, Nobel 1977",
    conceptual_nucleus="dissipative structures / self-organization / far-from-equilibrium / order from fluctuations",
    extended_definition="Non-equilibrium thermodynamics: systems far from equilibrium can spontaneously organize into dissipative structures. Self-organization: order emerges from fluctuations, not from external command. CRITICAL: never translate this directly into social physics. The physics applies to physical/chemical systems; social application is METHOD_TRANSLATION, not scientific equivalence.",
    what_it_changes="Shows that order can emerge from disorder under far-from-equilibrium conditions.",
    what_it_resists="Equilibrium as default; reduction to entropy-only thinking; direct translation into social physics.",
    what_it_is_not="NOT social physics; NOT 'everything self-organizes'; the physics is specific to non-equilibrium thermodynamic systems.",
    axes={"ontology": "dissipative structures", "transformation": "self-organization from fluctuations", "uncertainty": "far-from-equilibrium conditions"},
    conceptual_neighbors=["person:edward_norton_lorenz", "person:ludwig_von_bertalanffy", "person:edgar_morin"],
    misreading_risks=["Translating directly into social physics", "Treating as universal self-organization"])
